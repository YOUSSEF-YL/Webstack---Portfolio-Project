      ...
      <div className='flex flex-wrap'>
        <div className='w-full lg:w-1/2'>
          <div className='flex flex-col items-center lg:items-start lg:pl-16'>
           ...
           <p className='my-2 max-w-xl py-6 font-light tracking-tighter'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Nam, dolore qui. Dignissimos eius sunt aut eos laborum aliquam optio fugit cupiditate consequatur fuga itaque ea, temporibus minima animi dolorum esse!</p>
          </div>
        </div>
      </div>
    </div>
